...
@Injectable({
  ...
  export class ModelBuilderLocalApi implements CrudStateApiInterface<ModelDefinition>{

    constructor(@Inject(LOCAL_STORAGE) private storage: StorageService){
      let items = <ModelDefinition[]>this.storage.get(MODEL_BUILDER_LOCAL_STORAGE_KEY);
